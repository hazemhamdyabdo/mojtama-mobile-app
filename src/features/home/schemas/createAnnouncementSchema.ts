...
export function createAnnouncementSchema() {
  return z
    .object({
      announcementType: z.enum(ANNOUNCEMENT_TYPE_VALUES, {
      ...
      image: announcementImageSchema.nullable(),
...
export type AnnouncementImage = z.infer<typeof announcementImageSchema>;
