...
import VisibilityBottomSheet, {
  type VisibilityBottomSheetRef,
} from "@/features/home/components/VisibilityBottomSheet";
import {
      ...
      <Controller
        ...
        render={({ field: { value, onChange } }) => (
          <VisibilityBottomSheet
            ...
            value={value}
            onSelect={(option: VisibilityOption) => onChange(option)}
          />
        )}
      />
    </View>
